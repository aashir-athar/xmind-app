...
const NotificationCard = ({
  ...
  const getNotificationIcon = () => {
    switch (notification.type) {
      case "like":
        return <Feather name="heart" size={20} color="#7E57C2" />;
      case "comment":
        return <Feather name="message-circle" size={20} color="#42A5F5" />;
      case "follow":
        return <Feather name="user-plus" size={20} color="#FF7043" />;
      default:
  ...
  return (
    <View className="border-b border-borderLight bg-background">
      <View className="flex-row p-4">
        <View className="relative mr-3">
          ...
          <View className="abolute -bottom-1 -right-1 size-6 bg-mutedSurface items-center justify-center">
            {getNotificationIcon()}
          </View>
        </View>
        ...
        <View className="flex-1">
          <View className="flex-row items-start justify-between mb-1">
            <View className="flex-1">
              <Text className="text-textPrimary text-base leading-5 mb-1">
          ...
          {notification.comment && (
            <View className="bg-surface rounded-lg p-3 mb-2">
              <Text className="text-textSecondary text-xs mb-1">Comment:</Text>
